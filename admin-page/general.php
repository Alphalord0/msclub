      ...
      ?>
        ...
        <div class="inter-name">
            <div class="inter-name1">
                <h3 class="i-name">General Arts Students</h3>
                <p>Manage the General Arts students here.</p>
            ...
            <div class="inter-name2">
                <div class="value">
                    <a class="box">
                        <div class="va-box">
                            <span>Total number of General Arts Students</span>
                            <div class="tota">
        ...
        <div id="searchResults">
          ...
          $sql = "SELECT * FROM users WHERE class='general arts' ";
