      ...
      ?>
        ...
        <div class="inter-name">
            <div class="inter-name1">
                <h3 class="i-name">Economics Students</h3>
                <p>Manage the Economics students here.</p>
            ...
            <div class="inter-name2">
                <div class="value">
                    <a class="box">
                        <div class="va-box">
                            <span>Total number of Science Students</span>
                            <div class="tota">
       ...
       <div class="table">
        ...
        <div id="searchResults">
          ...
          $sql = "SELECT * FROM users WHERE class='h.economics' ";
