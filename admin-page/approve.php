         ...
         <nav class="navbar navbar-inverse">
                ...
                <div class="inter-name">
                    <div class="inter-name1">
                        <h3 class="i-name">Pending Members</h3>
            ...
            <th class="edd <?= activeEdit() ?>">Block</th></tr>
                ...
                <tr>
                    ...
                    <td class="eds <?= activeEdit() ?>">
                        <a class="ed" href="../php/accept.php?id=<?php echo $row['user_id']?>">ACCEPT</a>
                    </td>
                    <td class="eds <?= activeEdit() ?>">
                        <a class='de <?= activeEdit() ?>' href='../php/reject.php?id=<?php echo $row['user_id']?>'>REJECT</a>
                    </td>
                </tr>
            <?php
                }
