      ...
      ?>
        ...
        <div class="inter-name">
            <div class="inter-name1">
                <h3 class="i-name">Visual Arts Students</h3>
            ...
            <div class="inter-name2">
                <div class="value">
                    <a class="box">
                        <div class="va-box">
                            <span>Total number of Visual Arts Students</span>
                            <div class="tota">
        ...
        <div id="searchResults">
          ...
          $sql = "SELECT * FROM users WHERE class='visual arts' ";
