      ...
      ?>
        ...
        <div class="inter-name">
            <div class="inter-name1">
                <h3 class="i-name">Technical Students</h3>
                <p>Manage the Science students here.</p>
            ...
            <div class="inter-name2">
                <div class="value">
                    <a class="box">
                        <div class="va-box">
                            <span>Total number of Technical Students</span>
                            <div class="tota">
        ...
        <div id="searchResults">
          ...
          $sql = "SELECT * FROM users WHERE class='technical' ";
