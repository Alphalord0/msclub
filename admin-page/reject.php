    ...
    <div class="interhead">
            <div class="inter1">
                <i onclick="myBtn()" class="barrs fa fa-bars"></i>
                    <p>Dashboard/Stored rejected Members</p>
            </div>
      ...
      ?>
        ...
        <div class="inter-name">
            <div class="inter-name1">
                <h3 class="i-name">Stored Rejected Members</h3>
                <p>Manage your Store Rejected club members here.</p>
                <p>You can add or permanently delete rejected members from this page.</p>
            </div>
            ...
            <div class="inter-name2">
                <div class="value">
                    <a class="box">
                        <div class="va-box">
                            <span>Total of Stored Rejected Members</span>
                            <div class="tota">
                            ...
                            <p>Total number of Store rejected members in the club</p>
                        </div>
                    </a>
                </div>
            </div>
             ...
             ?>
                <tr>
                    ...
                    <td class="eds <?= activeEdit() ?>">
                        <a class="ed <?= activeEdit() ?>" href="../php/totalA.php?id=<?php echo $row['user_id']?>">ADD</a>
                    </td>
                    <td class="eds <?= activeEdit() ?>">
                        <a class='de <?= activeEdit() ?>' href='../php/totalD.php?id=<?php echo $row['user_id']?>'>DELETE</a>
                    </td>
                </tr>
            <?php
            }
